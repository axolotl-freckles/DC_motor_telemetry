...
class BezierWinddown : public Winddown {
public:
    // Implementación de los métodos virtuales puros de la clase padre Winddown
    ...
    BezierWinddown(float period_s, float start_setpoint, float end_setpoint);
    virtual ~BezierWinddown() { }
